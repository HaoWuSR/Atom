...
# MODEL=${1}
# /data1/suri/model/Llama-68M-Chat-v1
# /workspace/suri/model/llama-2-7b-Chat-fp16
# MODEL="/workspace/suri/model/llama-2-7b-Chat-fp16"
MODEL="/workspace/suri/model/Llama-68M-Chat-v1"
...
cmd_adv="--keeper 128 --keeper_precision 3 "
cmd_eval="--eval_ppl"
